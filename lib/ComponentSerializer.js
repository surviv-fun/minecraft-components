...
export default class ComponentSerializer {
    /**
     * @param { String } text
     * @param { ComponentParser | Null } parser
     */
    ...
    /**
     * converts everything into a stripped string ( without color codes )
    ...
    /**
     * converts the Serializer to a json string
     * @returns { String } json
     */
    json() {
    ...
    /**
     * converts the full String into a serialized one with only § delimiters
    ...
    /**
     * converts the given text into an html String
     * @returns { String } html
     */
    html() {
        // Parse text to JSON
    ...
    /**
     * converts the Serializer text into an HTML Entity
     * @returns { HTMLElement } element as div
     */
    toHtmlEntity() {
    ...
    /**
     * converts the Serializer in an object
    ...
    /**
     * Get the messahe as a MessageComponent
